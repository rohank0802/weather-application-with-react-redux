...
<div className="w-32 h-32 relative flex items-center justify-center my-7">
  <div
  ...
  <div className="w-full h-full relative flex items-center justify-center">
    <div
      className="absolute inset-0 rounded-xl bg-gradient-to-red from-cyan-500 via-blue-500 to-purple-500 animate-spin blur-sm"
    ></div>
    ...
    >
      ...
      <div
        className="absolute inset-0 bg-gradient-to-t0 from-transparent via-blue-500/10 to-transparent animate-pulse"
      ></div>
    </div>
  </div>
